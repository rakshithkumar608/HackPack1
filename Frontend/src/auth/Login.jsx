      ...
      <div className="w-1/2 bg-[#fff1db] flex flex-col justify-center px-16 py-12">
        <div className="max-w-md">
          ...
          <p className="text-base text-slate-800 mb-6">
            Continue practicing trading with virtual money and track your
            progress in a risk‑free environment.
          </p>
        </div>
        ...
        <div className="mt-4">
          <div className="w-full max-w-xl">
            ...
            <img
              src="https://images.theconversation.com/files/632411/original/file-20241116-15-f85mdu.jpg?ixlib=rb-4.1.0&rect=622%2C0%2C5633%2C3755&q=50&auto=format&w=768&h=512&fit=crop&dpr=2"
